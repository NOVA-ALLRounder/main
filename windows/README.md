...
[![Windows](https://img.shields.io/badge/Windows-0078D4?style=flat&logo=windows)](https://www.microsoft.com/windows)

## Windows Quick Start

See `windows/WINDOWS_SETUP.md` for the Windows-compatible runtime/build flow and PowerShell entry points.
