...
<<<<<<< HEAD:apps/core/src/visual_driver.rs
    
    #[cfg(target_os = "macos")]
=======

>>>>>>> origin/steer/develop:core/src/visual_driver.rs
    ...
    fn capture_image_internal() -> Result<image::DynamicImage> {
        Err(anyhow::anyhow!("Screen capture is currently supported only on macOS."))
    }
