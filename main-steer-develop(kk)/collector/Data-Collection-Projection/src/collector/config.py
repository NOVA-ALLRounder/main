...
class PostCollectionConfig:
    ...
    routine_n_min: int = 2
    routine_n_max: int = 3
    run_n8n_workflow: bool = False
    run_n8n_quality_loop: bool = False
    n8n_min_score: int = 85
    n8n_max_attempts: int = 3
    send_n8n_workflow: bool = False
    n8n_webhook_url: str = ""
    n8n_webhook_env: str = "N8N_WEBHOOK_URL"
    n8n_profile_path: str = "configs/personalization_demo.json"
    n8n_score_config_path: str = "configs/score_config.json"
...
def load_config(path: str | Path) -> Config:
    ...
    post_collection = PostCollectionConfig(
        ...
        run_n8n_workflow=bool(post_raw.get("run_n8n_workflow", False)),
        run_n8n_quality_loop=bool(post_raw.get("run_n8n_quality_loop", False)),
        n8n_min_score=int(post_raw.get("n8n_min_score", 85)),
        n8n_max_attempts=int(post_raw.get("n8n_max_attempts", 3)),
        send_n8n_workflow=bool(post_raw.get("send_n8n_workflow", False)),
        n8n_webhook_url=str(post_raw.get("n8n_webhook_url", "")).strip(),
        n8n_webhook_env=str(post_raw.get("n8n_webhook_env", "N8N_WEBHOOK_URL")).strip(),
        n8n_profile_path=str(post_raw.get("n8n_profile_path", "configs/personalization_demo.json")).strip(),
        n8n_score_config_path=str(post_raw.get("n8n_score_config_path", "configs/score_config.json")).strip(),
    )
